...
window.plugin.portalslist.displayPL = function() {
  ...
  if(window.useAndroidPanes()) {
    ...
    dialog({
      ...
      id: 'portal-list',
      width: 700,
      buttons: {'Download KML': function() {window.plugin.portalslist.downloadKML();}}
    });
  }
}

window.plugin.portalslist.downloadKML = function() {
  ...
  saveAs(new Blob([kmlData], {type: 'text/plain;charset=' + document.characterSet}), "portals.kml");
}
